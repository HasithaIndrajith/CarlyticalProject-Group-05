        ...
        <>
            ...
            <div>
                        ...
                        <div className='col-md-4 container'>
                            <Card className='shadow'>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        View the interactive dashboard for valuable insights about car insurance purchases
                                    </Card.Text>
                <br></br>

                                    <div className='text-center'>
                                        <Button variant="primary" href='/home'>View Dashboard</Button>
                                    </div>
                                </Card.Body>
                            </Card>
                        </div>
                ...
                <br></br>
                                    ...
                                    <div className='text-center'>
                                        <Button variant="primary" href='/home'>Predict for Customer</Button>
                                    </div>
                                </Card.Body>
                            </Card>
                        </div>
                ...
                <br></br>
                                    ...
                                    <div className='text-center'>
                                        <Button variant="primary" href='/leaveApplication'>Predict for Dataset</Button>
                                    </div>
                                </Card.Body>
                            </Card>
                        </div>
